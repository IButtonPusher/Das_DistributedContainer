...
namespace Das.Container
{
                                     ...
                                     IObjectBuilder
   {
      ...
      Task<Object> IDeferredLoader.GetAwaiter() => Task;
                                                       ...
                                                       ConstructorWorker ctorWorker)
      {
         ...
         var gObj = await PerformObjectResolutionAsync(gargs[0], valueIndex).ConfigureAwait(false);
      ...
      private static readonly Object[] _emptyCtorParams =
         #if NET40
           new Object[0];
         #else
         Array.Empty<Object>();
